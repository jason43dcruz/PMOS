...
| **Jason's own meeting notes** | `creator = currentUser() AND lastModified > now("-1d") AND space = "~349409947"` | — |
...
2. Scan messages for action items directed at Jason — look for:
   - Direct asks: "can you...", "could you...", "would you...", "please..."
   - Commitments Jason made in the thread: "I'll...", "will send", "will look at"
   - Follow-up requests: "let me know", "circle back", "confirm", "by [date]"
   - Anything time-bound or explicitly awaiting Jason's response
...
**What to ignore in DMs:** casual chat, FYIs, things Jason already responded to in the thread, bot/automated messages.
...
- **Action items** explicitly assigned to Jason (look for "Jason to...", "JDC to...", "@Jason", "you will...", "can you...")
- **Follow-up requests** — "let me know", "circle back", "send me", "confirm by"
- **Commitments Jason made** — "I'll...", "will send", "will share"
- **Open questions** directed at Jason that haven't been answered
...
Send a Slack DM to channel `DFFF0J94G` with:
...
| Send Slack summary | Slack MCP: `channel_create_message` to `DFFF0J94G` |

## Infrastructure

### Confidence Scoring
- **[HIGH]** — Explicit action item with Jason named
