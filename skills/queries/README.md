...
**Related Goal:** [ATLAS-117783 - [YOUR PRODUCT] Uplift](https://home.atlassian.com/o/2346a038-3c8c-498b-a79b-e7847859868d/s/a436116f-02ce-4520-8fbb-7301462a1674/goal/ATLAS-117783/about)  
**Priority:** P0  
**Target:** Feb 1–Jun 30, 2026  
**What it measures:** % of [YOUR PRODUCT] organizations with all licenses uplifted to [YOUR PRODUCT], split by Paid vs. Free orgs  
...
**What it measures:** Feature activation % by edition (28d window). Scalable template — swap the `feature_active` CTE for any [YOUR PRODUCT] feature. Includes reference swaps for Change Management, Incident Management, Problem Management, Assets, Virtual Agent, Automation, Smart Summaries, Deployment Gating, Heartbeat Monitoring, and more.  
